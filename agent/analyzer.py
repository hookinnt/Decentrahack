...
- Риск 0-39: Прямой угрозы нет. Статус: NORMAL. Действие не требуется.
- Риск 40-79: Ситуация нестабильна. Возможны косвенные потери. Статус: WARNING. Требуется мониторинг.
- Риск 80-100: КРИТИЧЕСКАЯ УГРОЗА (взлом протокола, эксплойт, отток ликвидности). ТРЕБУЕТСЯ МГНОВЕННАЯ БЛОКИРОВКА (action_required: true).
...
- Ответ только в формате чистого JSON: {"risk_score": X, "reason": "...", "action_required": true/false}
"""
